...
const UpdateTransaction = () => {
    ...
    useEffect(() =>{
        axios.get("http://localhost:8000/api/transactions/"+id,{withCredentials: true})
            .then(res => {
                ...
                let monthArray = ["Ene", "Feb", "Mar", "Apr", "May", "Jun", "Jul","Ago", "Sep", "Oct", "Nov", "Dic"];
                let monthNumber = 0
    ...
    return (
        ...
        <div className={styles.page}>
            <h2 className={styles.page__title}>Actualizar Transacción</h2>
            <form onSubmit={updateTransaction} className={styles.transaction}>
                <div className={styles.transaction__control}>
                    <label className={styles.transaction__label}>Tipo:</label>
                    <select 
                ...
                <div className={styles.transaction__control__big}>
                    <label htmlFor="description" className={`${styles.transaction__label}`}>Descripción:</label>
                    <textarea
                        // rows={15}
                        // cols={5}
                ...
                <div className={styles.transaction__control}>
                    <label htmlFor="amount" className={styles.transaction__label}>Valor:</label>$
                    <input 
                ...
                <div className={styles.transaction__control}>
                    <label className={styles.transaction__label}>Categoría:</label>
                        <select
                ...
                <div className={styles.transaction__control}>
                    <label className={styles.transaction__label}>Fecha:</label>
                    <input 
