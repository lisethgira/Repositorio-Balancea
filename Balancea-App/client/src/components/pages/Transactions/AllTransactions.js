...
const AllTransactions = () => {
    ...
    return (
        <div className={styles.page}>
            <h2 className={styles.page__title}>Todas las transacciones</h2>
            {/* 
            ...
            <table className={styles.table}>
                <thead className={styles.table__head}>
                    <tr className={styles.table__tr}>
                        ...
                        <th className={styles.table__th}>Titulo</th>
                        <th className={styles.table__th}>Valor</th>
                        <th className={styles.table__th}>Categoría</th>
                        <th className={styles.table__th}>Fecha</th>
                        <th className={styles.table__th}>Acciones</th>
                    </tr>
                </thead>
                    ...
                    <tbody className={styles.table__body}>
                        ...
                        {transactionList.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="5">Aún no has registrado ninguna transacción.</td>
                            </tr>
                        )}
                    </tbody>
