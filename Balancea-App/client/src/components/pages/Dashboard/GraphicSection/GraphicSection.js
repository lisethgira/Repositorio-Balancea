            ...
            <div style={{
                ...
                {payload.map(item => (
                    <p key={item.name} style={{ color: item.stroke }}>
                        {item.name === "Income" ? "Ingresos" : "Gastos"}: {item.value.toLocaleString()}
                    </p>
                ))}
            </div>
        );
    ...
    return (
        <div className={styles.graphic__section}>
            ...
            <div className={styles.graphic__label}>
                <h2 className={styles.graphic__title}>Mi historial de saldo</h2>
                ...
                <Dropdown 
                    ...
                    options={["Último año","Último mes","Última semana"]}>
                </Dropdown>
            </div>
            ...
            <div className={styles.graphic}>
                ...
                margin={{ top: 30, right: 40, left: 10, bottom: 10 }}>
                    ...
                    <Area type="monotone" dataKey="Income"  name="Ingresos" stroke="#00D6BD" fillOpacity={0.5} fill="url(#colorPv)" />
                    <Area type="monotone" dataKey="Expenses" name="Gastos" stroke="#ff7a95" fillOpacity={0.6} fill="url(#colorUv)" />
                </AreaChart>
                </ResponsiveContainer>
            </div>
