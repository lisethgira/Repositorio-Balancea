            ...
            <div className={styles.user}>
                <form onSubmit={updateProfile} className={styles.user__form}>
                    ...
                    <div className={styles.user__extend}>
                        <div className={styles.user__label}>
                            ...
                            <div className={styles.user__info}>
                                <label className={styles.x} htmlFor="firstName">Nombre:</label>
                        ...
                        <div className={styles.user__label}>
                            ...
                            <div className={styles.user__info}>
                                <label htmlFor="cellphone">Correo:</label>
                    ...
                    <div className={styles.user__submit}>
                        <button type="submit" className={styles.user__button}>Guardar</button>
                    </div>
                </form>
            </div>
