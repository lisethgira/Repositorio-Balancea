...
const months = [
      {month: "Ene", startDate: `${thisYear}-01-01`, endDate: `${thisYear}-01-31`},
      ...
      {month: "Ago", startDate: `${thisYear}-08-01`, endDate: `${thisYear}-08-31`},
...
const weekDays = [
  {month: "Lun", startDate: `${addDays(thisMonday,0)}`, endDate: `${addDays(thisMonday,1)}`},
  {month: "Mar", startDate: `${addDays(thisMonday,1)}`, endDate: `${addDays(thisMonday,2)}`},
  {month: "Mie", startDate: `${addDays(thisMonday,2)}`, endDate: `${addDays(thisMonday,3)}`},
  {month: "Jue", startDate: `${addDays(thisMonday,3)}`, endDate: `${addDays(thisMonday,4)}`},
  {month: "Vie", startDate: `${addDays(thisMonday,4)}`, endDate: `${addDays(thisMonday,5)}`},
  {month: "Sab", startDate: `${addDays(thisMonday,5)}`, endDate: `${addDays(thisMonday,6)}`},
  {month: "Dom", startDate: `${addDays(thisMonday,6)}`, endDate: `${addDays(thisMonday,7)}`},
]
